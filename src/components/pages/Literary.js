...
function Literary() {
    return <>
        <div id="literarypage" className="carousel slide border border-dark" data-bs-ride="carousel">
            <div className="carousel-inner ">
                <div className="carousel-item container1 active">
                    <img src="literary_background.jpg" className="bg1 d-block w-100" alt="..." />
                    <div className="centered1">LITERARY<br/><div className="centeredpara">"The Literary Club is on a committed
                    mission to amplify all the thought provoking voices of students and to help them realize their ideas."
                    </div>
